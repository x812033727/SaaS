...
- **定金退款一次即終態(可全額或部分)**:擁有者／管理員取消預約後，可從預約頁對新的正式綠界信用卡交易送出原交易退刷(金額欄預設全額,可改部分);部分退款後餘額不可再自動退,需人工。退款成功會 LINE 通知顧客(受 BOOKING_NOTIFY 功能旗標閘門)。舊資料缺交易編號、非信用卡、原商店已更換，或退款網路結果不確定時，必須先在原金流後台核對，再於系統確認人工退款(可填實際退款金額)。綠界正式信用卡請退款 API 無可實際授權的測試環境，上線後仍需以自有低額正式交易驗收。
