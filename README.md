...
| 員工抽成／薪資結算 | `STAFF_COMMISSIONS`（pro） | `/ui/commissions`、`/ui/pos` | 服務／商品百分比或固定抽成、生效日版本、折扣前後基礎、小費、成交快照、沖銷與 pay run |
...
專業版 owner 可在 `/ui/commissions` 為每位員工分別設定服務／商品抽成。規則支援百分比或
